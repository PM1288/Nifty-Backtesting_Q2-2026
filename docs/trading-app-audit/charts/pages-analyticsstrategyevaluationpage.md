# pages-analyticsstrategyevaluationpage
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsStrategyEvaluationPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsStrategyEvaluationPage.tsx) |
| Components | `AnalyticsStrategyEvaluationPage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | Strategy Evaluation |
