...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/FnoVolatilityPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/FnoVolatilityPage.tsx#L19) |
| Used by routes | `/dashboard/stocks/:symbol`, `/options/volatility-signals`, `/stock/:symbol` |
| CSS modules | `./FnoVolatilityPage.module.css` |
