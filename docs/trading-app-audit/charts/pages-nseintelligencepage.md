...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/NseIntelligencePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/NseIntelligencePage.tsx) |
| Components | `BreadthTrend`, `Reports`, `NseIntelligencePage` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | Breadth history unavailable; Official advance minus decline breadth trend; ${date(row.tradeDate)} · ${number(value, 2)}%; NSE Intelligence is unavailable; NSE Intelligence views; ${active === ; No normalized events available |
