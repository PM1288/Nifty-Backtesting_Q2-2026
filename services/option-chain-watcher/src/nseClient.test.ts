...
const asOf = DateTime.fromISO('2026-08-17T12:00:00', { zone: 'Asia/Kolkata' });

test('picks nearest weekly and last expiry of the front available month', () => {
  const roles = pickExpiryRoles(['18-Aug-2026', '25-Aug-2026', '01-Sep-2026', '29-Sep-2026'], asOf);
...
test('deduplicates weekly and monthly when only the monthly expiry remains', () => {
  const roles = pickExpiryRoles(['25-Aug-2026', '01-Sep-2026', '29-Sep-2026'], asOf);
