...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/BacktestingPortfolioResultsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/BacktestingPortfolioResultsPage.tsx#L20) |
| Used by routes | `/dashboard/stocks/:symbol`, `/backtesting/results`, `/stock/:symbol` |
