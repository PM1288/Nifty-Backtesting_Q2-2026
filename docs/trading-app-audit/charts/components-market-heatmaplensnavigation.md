# components-market-heatmaplensnavigation
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/market/HeatmapLensNavigation.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/market/HeatmapLensNavigation.tsx) |
| Components | `HeatmapLensNavigation` |
| Library | CSS/DOM visualisation |
| Pages | `/heatmap/change`, `/heatmap/rsi`, `/heatmap/will` |
| Titles found | Heatmap metric lens |
