...
import {
  CandlestickSeries, ColorType, CrosshairMode, HistogramSeries, LineSeries, createChart, createSeriesMarkers,
...
import { maxPainOverlayState, observedSessionBounds, paddedSessionBounds } from "../../lib/scalperV2Geometry";
...
export function ScalperV2Chart({
  ...
  useEffect(() => {
    ...
    scheduleProfile();
  }, [data, emaData, id, profileBounds, profileRangeExpanded, renderBounds, showEma, showVolumeEma, verticalView, volumeData, volumeEmaData, volumeEmaPeriod, volumeLabel, yLocked]);
