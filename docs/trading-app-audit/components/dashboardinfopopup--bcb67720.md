...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/market/DashboardInfoPopup.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/market/DashboardInfoPopup.tsx#L36) |
| Used by routes | `/` |
| CSS modules | `./DashboardInfoPopup.module.css` |
