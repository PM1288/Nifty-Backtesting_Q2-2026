...
try {
  ...
  check("EVALUATION", await dashboard.getByText(/Historical evaluation/).count() === 1 && (await dashboard.innerText()).includes("not causal"), "matched daily evaluation and limitation disclosure visible");
