...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/BacktestingStrategyDetailPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/BacktestingStrategyDetailPage.tsx#L30) |
| Used by routes | `/dashboard/stocks/:symbol`, `/backtesting/strategies/:strategyId`, `/stock/:symbol` |
