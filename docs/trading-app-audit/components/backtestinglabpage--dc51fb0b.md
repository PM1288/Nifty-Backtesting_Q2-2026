...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/BacktestingLabPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/BacktestingLabPage.tsx#L50) |
| Used by routes | `/dashboard/stocks/:symbol`, `/backtesting/lab`, `/stock/:symbol` |
| CSS modules | `./AnalyticsPage.module.css`, `./BacktestingLabPage.module.css` |
