...
export const ROUTE_COMMANDS: readonly RouteEntry[] = [
  ...
  { id: "three-month-strategy", group: "Strategies", label: "3Month Strategy", to: "/strategy/three-month", description: "NIFTY 500 Bull/Bear reversal screen across Month, Week, Day, 1H and 15m", keywords: ["three month", "recovery screener", "NIFTY 500"] },
