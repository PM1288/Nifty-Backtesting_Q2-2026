...
| Components | `AnalyticsFiiFlowPage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/catalysts/context`, `/institutional/flow`, `/stock/:symbol` |
| Titles found | FII / DII & Participant Flow |
