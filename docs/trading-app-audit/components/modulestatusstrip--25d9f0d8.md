...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/design-system/WorkspacePrimitives.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/design-system/WorkspacePrimitives.tsx#L8) |
| Used by routes | `/`, `/institutional/flow`, `/strategy/rolling-monthly/legacy` |
