...
export type MwhdRanking = Pick<ProgressionMatrixRow,
  "rank" | "starterState" | "bothStartersFailed" | "allGreen" | "best"
  | "bearRank" | "bearStarterState" | "bearBothStartersFailed" | "bearAllRed" | "bearBest"
>;
