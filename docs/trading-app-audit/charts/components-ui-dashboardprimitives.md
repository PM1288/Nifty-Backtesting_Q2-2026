# components-ui-dashboardprimitives
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/ui/DashboardPrimitives.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/ui/DashboardPrimitives.tsx) |
| Components | `ButtonLink`, `ExternalButtonLink`, `ButtonButton`, `ButtonPrimary`, `ButtonSecondary`, `ButtonTertiary`, `StatusBadge`, `SectionTabs`, `PageIntroAccordion`, `DensityBadge`, `DataState`, `LoadingState`, `EmptyState`, `ErrorState`, `DelayedState`, `PartialState`, `SectionDivider`, `KpiCard`, `SymbolPill`, `InterpretationCard`, `PlainLanguageCard`, `ChartCard`, `LoadingSkeletonCard`, `LoadingTableCard` |
...
| Titles found | ${tr(title)} ${t(; ${tr(title)} table |
