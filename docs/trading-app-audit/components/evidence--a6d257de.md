...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/PaperTradingCommandCenter.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/PaperTradingCommandCenter.tsx#L3073) |
| Used by routes | `/backtesting`, `/backtesting/strategies/:strategyId`, `/strategy/oiis-live`, `/strategy/monthly`, `/strategy/rolling-monthly`, `/strategy/rolling-monthly/legacy`, `/paper-trading` |
