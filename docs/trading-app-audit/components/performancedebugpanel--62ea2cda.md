...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/analytics/PerformanceDebugPanel.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/analytics/PerformanceDebugPanel.tsx#L21) |
| Used by routes | `/` |
| CSS modules | `./PerformanceDebugPanel.module.css` |
