...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/BacktestingRegimeAnalysisPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/BacktestingRegimeAnalysisPage.tsx#L18) |
| Used by routes | `/dashboard/stocks/:symbol`, `/backtesting/regimes`, `/stock/:symbol` |
