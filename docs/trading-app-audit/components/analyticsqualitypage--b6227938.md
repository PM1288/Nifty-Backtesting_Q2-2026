...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsQualityPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsQualityPage.tsx#L368) |
| Used by routes | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| CSS modules | `./AnalyticsQualityPage.module.css` |
