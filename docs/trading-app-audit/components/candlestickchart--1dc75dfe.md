...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/CandlestickChart.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/CandlestickChart.tsx#L121) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./CandlestickChart.module.css` |
