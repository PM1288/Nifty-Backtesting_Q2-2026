...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/stocks/StockProfileControls.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/stocks/StockProfileControls.tsx#L10) |
| Used by routes | `/analytics/learn`, `/analytics/simulator`, `/analytics/indicators`, `/analytics/indicators/:slug`, `/analytics/stock/:symbol`, `/strategy/monthly`, `/strategy/rolling-monthly`, `/paper-trading` |
| CSS modules | `./StockProfileControls.module.css` |
