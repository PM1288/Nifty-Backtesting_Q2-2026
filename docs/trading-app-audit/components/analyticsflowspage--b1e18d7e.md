...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsFlowsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsFlowsPage.tsx#L29) |
| Used by routes | `/dashboard/stocks/:symbol`, `/catalysts/events`, `/institutional/reports`, `/analytics/flows`, `/stock/:symbol` |
