...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsLeadershipPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsLeadershipPage.tsx#L213) |
| Used by routes | `/dashboard/stocks/:symbol`, `/analytics/leadership`, `/stock/:symbol` |
| CSS modules | `./AnalyticsLeadershipPage.module.css` |
