...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/stocks/StockProfileControls.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/stocks/StockProfileControls.tsx#L13) |
| Used by routes | `/`, `/strategy/oiis-live`, `/strategy/monthly`, `/strategy/rolling-monthly`, `/strategy/rolling-monthly/legacy`, `/paper-trading` |
