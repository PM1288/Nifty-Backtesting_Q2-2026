...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/WillHeatmap.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/WillHeatmap.tsx) |
| Components | `WillHeatmap`, `TOP_GUTTER`, `ROW_HEIGHT`, `SYMBOL_COL`, `WILLR_COL`, `LABEL_GUTTER_TOTAL`, `ANIMATION_MS` |
