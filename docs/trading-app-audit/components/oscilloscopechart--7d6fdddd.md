...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/OscilloscopeChart.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/OscilloscopeChart.tsx#L18) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./OscilloscopeChart.module.css` |
