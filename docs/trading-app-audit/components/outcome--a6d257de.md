...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/PaperTradingCommandCenter.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/PaperTradingCommandCenter.tsx#L1208) |
| Used by routes | `/feedback`, `/options/structure`, `/options/snapshot`, `/strategy/rolling-monthly/legacy`, `/paper-trading` |
