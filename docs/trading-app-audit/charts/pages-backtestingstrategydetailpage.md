# pages-backtestingstrategydetailpage
...
| Components | `BacktestingStrategyDetailPage` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/backtesting/strategies/:strategyId`, `/stock/:symbol` |
| Titles found | ${tr(detail.data.strategy.displayName)} • v${detail.data.version.versionNumber}; Strategy verdict |
