...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/paper/PaperWorkbenchPrimitives.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/paper/PaperWorkbenchPrimitives.tsx#L16) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./PaperWorkbenchPrimitives.module.css` |
