# components-visual-marketgradientwaves
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/MarketGradientWaves.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/MarketGradientWaves.tsx) |
| Components | `MarketGradientWaves` |
| Library | Custom SVG/React |
| Pages | Indirect/shared |
