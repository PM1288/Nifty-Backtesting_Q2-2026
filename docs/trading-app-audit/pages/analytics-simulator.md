...
| Main component | `AnalyticsSimulatorPage` |
...
- [1920×1080](../screenshots/desktop/analytics-simulator__1920x1080__full.png)
- [1440×900](../screenshots/desktop/analytics-simulator__1440x900__full.png)
- [1024×768](../screenshots/tablet/analytics-simulator__1024x768__full.png)
- [390×844](../screenshots/mobile/analytics-simulator__390x844__full.png)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1024x768 | 200 | CAPTURED | What this scenario is asking you to tolerate | 1 | 4 | 24 | 0 | 0 | NO |
| 1440x900 | 200 | CAPTURED | What this scenario is asking you to tolerate | 1 | 4 | 24 | 0 | 0 | NO |
| 1920x1080 | 200 | CAPTURED | What this scenario is asking you to tolerate | 1 | 4 | 24 | 0 | 4 | NO |
| 390x844 | 200 | CAPTURED | What this scenario is asking you to tolerate | 1 | 4 | 24 | 0 | 0 | NO |
...
| GET | /n50/v1/analytics/simulator/universe | 200 |
| GET | /n50/v1/analytics/simulator | 200 |


### Captured evidence

- [chart 1 — 1920x1080](../screenshots/charts/analytics-simulator__chart-1.png)
- [chart 2 — 1920x1080](../screenshots/charts/analytics-simulator__chart-2.png)
- [chart 3 — 1920x1080](../screenshots/charts/analytics-simulator__chart-3.png)
- [full page — 1440x900](../screenshots/desktop/analytics-simulator__1440x900__full.png)
- [full page — 1920x1080](../screenshots/desktop/analytics-simulator__1920x1080__full.png)
- [full page — 390x844](../screenshots/mobile/analytics-simulator__390x844__full.png)
- [full page — 1024x768](../screenshots/tablet/analytics-simulator__1024x768__full.png)
<!-- RUNTIME_AUDIT_END -->
