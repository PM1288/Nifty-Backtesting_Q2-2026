# pages-analyticseventcontextpage
...
| Components | `CatalystCard`, `AnalyticsEventContextPage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/catalysts/context`, `/stock/:symbol` |
| Titles found | Event Context; A. Most important upcoming catalysts; B. Most important recent catalysts |
