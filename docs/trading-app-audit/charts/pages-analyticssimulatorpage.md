...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsSimulatorPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsSimulatorPage.tsx) |
| Components | `ComparisonBarChart`, `TimelineChart`, `DrawdownChart`, `ChargePanel`, `AnalyticsSimulatorPage`, `DEFAULT_QUERY`, `PRELOADED_UNIVERSE`, `CHART_COLORS`, `LEGEND_BOTTOM`, `DEFAULT_SAVINGS_RATE_PCT` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/backtesting`, `/backtesting/strategies/:strategyId`, `/stock/:symbol` |
| Titles found | Charges Paid; Estimated Exit Charges Today |
