...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsFiiReportsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsFiiReportsPage.tsx) |
| Components | `AnalyticsFiiReportsPage` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | FII Reports |
