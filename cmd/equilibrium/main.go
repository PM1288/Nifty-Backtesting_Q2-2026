...
import (
	...
	"trading-stack/internal/equilibrium"
...
func main() {
	...
	runtimeCfg.ServiceName = "equilibrium"
	...
	runner := equilibrium.NewRunner(cfg, st, baseLogger, loc)
	if err := runner.Run(ctx); err != nil && ctx.Err() == nil {
		logger.Error("equilibrium runner exited", "err", err)
		os.Exit(1)
	}
}
