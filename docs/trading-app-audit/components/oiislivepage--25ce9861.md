...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/OiisLivePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/OiisLivePage.tsx#L164) |
| Used by routes | `/dashboard/stocks/:symbol`, `/strategy/oiis-live`, `/stock/:symbol` |
| CSS modules | `./OiisLivePage.module.css` |
