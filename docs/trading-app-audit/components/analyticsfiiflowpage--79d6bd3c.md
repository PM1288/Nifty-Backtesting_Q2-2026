...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsFiiFlowPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsFiiFlowPage.tsx#L390) |
| Used by routes | `/dashboard/stocks/:symbol`, `/catalysts/context`, `/institutional/flow`, `/stock/:symbol` |
| CSS modules | `./AnalyticsFiiFlowPage.module.css` |
