...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/ui/DashboardPrimitives.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/ui/DashboardPrimitives.tsx#L390) |
| Used by routes | `/catalysts/events`, `/institutional/reports`, `/analytics/flows` |
