...
| Components | `ExtremesStrip`, `HeatmapTrend`, `WillSurfacePage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/heatmap/change`, `/heatmap/rsi`, `/heatmap/will`, `/stock/:symbol` |
| Titles found | ${tr(; Bottom 3; Top 3 |
