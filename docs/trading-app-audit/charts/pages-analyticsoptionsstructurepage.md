# pages-analyticsoptionsstructurepage
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsOptionsStructurePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsOptionsStructurePage.tsx) |
| Components | `AnalyticsOptionsStructurePage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | Options Structure |
