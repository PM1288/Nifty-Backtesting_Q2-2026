# components-visual-echartsurface
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/EChartSurface.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/EChartSurface.tsx) |
| Components | `EChartSurface` |
| Library | Apache ECharts 6 |
| Pages | `/analytics/leadership`, `/analytics/daily-setups`, `/catalysts/context`, `/analytics/learn`, `/analytics/simulator`, `/analytics/indicators`, `/analytics/indicators/:slug`, `/analytics/stock/:symbol`, `/institutional/flow`, `/options/intelligence`, `/strategy/rolling-monthly/legacy`, `/heatmap/change`, `/heatmap/rsi`, `/heatmap/will` |
