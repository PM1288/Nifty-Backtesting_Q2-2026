...
| CAN-003 | OFactor qualified 74, Tier A 82; XFactor Tier B 76, Tier A 84 | Entry thresholds preserved in `OIIS-CASH-DAILY-RESEARCH-V1.1`; V1.0 is superseded for exits because it violated the common target-only contract. |
