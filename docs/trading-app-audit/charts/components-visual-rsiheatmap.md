...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/RsiHeatmap.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/RsiHeatmap.tsx) |
| Components | `RsiHeatmap`, `TOP_GUTTER`, `ROW_HEIGHT`, `SYMBOL_COL`, `RSI_COL`, `LABEL_GUTTER_TOTAL`, `ANIMATION_MS` |
