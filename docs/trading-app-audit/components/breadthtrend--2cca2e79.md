...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/NseIntelligencePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/NseIntelligencePage.tsx#L34) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./NseIntelligencePage.module.css` |
