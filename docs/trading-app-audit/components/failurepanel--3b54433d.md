...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/design-system/TradingPrimitives.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/design-system/TradingPrimitives.tsx#L100) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./TradingPrimitives.module.css` |
