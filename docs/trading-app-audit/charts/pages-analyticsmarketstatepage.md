# pages-analyticsmarketstatepage
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsMarketStatePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsMarketStatePage.tsx) |
| Components | `AnalyticsMarketStatePage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | Market State |
