...
export function participantComparison(current: Facts[], previous: Facts[]): Facts[] {
  ...
  return current.map((row) => {
    ...
    return {
      ...
      previous_option_index_call_long: prior?.option_index_call_long ?? null,
      previous_option_index_call_short: prior?.option_index_call_short ?? null,
      previous_net_calls: prior?.net_calls ?? null,
      previous_option_index_put_long: prior?.option_index_put_long ?? null,
      previous_option_index_put_short: prior?.option_index_put_short ?? null,
      previous_net_puts: prior?.net_puts ?? null,
      previous_net_futures: prior?.net_futures ?? null,
      previous_options_proxy: prior?.options_proxy ?? null,
      delta_option_index_call_long: delta("option_index_call_long"),
      delta_option_index_call_short: delta("option_index_call_short"),
      delta_net_calls: delta("net_calls"),
      delta_option_index_put_long: delta("option_index_put_long"),
      delta_option_index_put_short: delta("option_index_put_short"),
      delta_net_puts: delta("net_puts"),
