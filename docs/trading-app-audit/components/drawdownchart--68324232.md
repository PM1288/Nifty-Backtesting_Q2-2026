...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/indicators/IndicatorEducationBlocks.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/indicators/IndicatorEducationBlocks.tsx#L898) |
| Used by routes | `/backtesting`, `/backtesting/strategies/:strategyId` |
| CSS modules | `./IndicatorEducationBlocks.module.css` |
