...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/RsiSurfacePage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/RsiSurfacePage.tsx#L107) |
| Used by routes | `/dashboard/stocks/:symbol`, `/heatmap/change`, `/heatmap/rsi`, `/heatmap/will`, `/stock/:symbol` |
| CSS modules | `./RsiSurfacePage.module.css` |
