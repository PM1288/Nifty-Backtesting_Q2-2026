...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsIndicatorsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsIndicatorsPage.tsx) |
| Components | `AnalyticsIndicatorsPage`, `DEFAULT_INDICATOR_SLUG` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | ${strategySnapshot.data.signalChart.name} • ${strategySnapshot.data.signalChart.sector} |
