...
def get_settings() -> Settings:
    return Settings(
        ...
        cron_sync_raw=os.getenv("CRON_SYNC_RAW", "*/1 9-15 * * 1-5"),
        cron_refresh_features=os.getenv("CRON_REFRESH_FEATURES", "*/1 9-15 * * 1-5"),
        cron_refresh_dashboard=os.getenv("CRON_REFRESH_DASHBOARD", "*/1 9-15 * * 1-5"),
        cron_refresh_watchlists=os.getenv("CRON_REFRESH_WATCHLISTS", "*/2 9-15 * * 1-5"),
        cron_run_quality=os.getenv("CRON_RUN_QUALITY", "*/5 9-15 * * 1-5"),
        cron_finalize_session=os.getenv("CRON_FINALIZE_SESSION", "40 15 * * 1-5"),
