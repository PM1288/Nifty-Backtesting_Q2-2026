...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/market/StockPixelField.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/market/StockPixelField.tsx#L24) |
| Used by routes | Indirect/shared use; search import graph |
| CSS modules | `./StockPixelField.module.css` |
