...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/ChangeHeatmap.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/ChangeHeatmap.tsx#L43) |
| Used by routes | `/dashboard/stocks/:symbol`, `/heatmap/change`, `/stock/:symbol` |
| CSS modules | `./RsiHeatmap.module.css` |
