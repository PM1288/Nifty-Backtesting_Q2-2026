...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/LongOptionsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/LongOptionsPage.tsx#L38) |
| Used by routes | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| CSS modules | `./LongOptionsPage.module.css` |
