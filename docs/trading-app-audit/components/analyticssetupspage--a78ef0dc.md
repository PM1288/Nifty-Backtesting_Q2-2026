...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsSetupsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsSetupsPage.tsx#L136) |
| Used by routes | `/dashboard/stocks/:symbol`, `/analytics/daily-setups`, `/stock/:symbol` |
| CSS modules | `./AnalyticsSetupsPage.module.css` |
