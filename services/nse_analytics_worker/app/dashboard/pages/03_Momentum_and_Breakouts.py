...
st.caption("Trend continuation, breakouts, and breakdowns.")
...
perf = run_query("""
    ...
    WHERE analysis_type = 'momentum_breakout'
...
line_chart(history, x="trade_date", y="signal_count", title="Momentum signal count")
st.subheader("Latest momentum candidates")
