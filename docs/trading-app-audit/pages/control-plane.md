...
- [1920×1080](../screenshots/desktop/control-plane__1920x1080__full.png)
- [1440×900](../screenshots/desktop/control-plane__1440x900__full.png)
- [1024×768](../screenshots/tablet/control-plane__1024x768__full.png)
- [390×844](../screenshots/mobile/control-plane__390x844__full.png)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1024x768 | 200 | CAPTURED | SmartAPI collector status | 5 | 1 | 6 | 0 | 4 | NO |
| 1440x900 | 200 | CAPTURED | SmartAPI collector status | 5 | 1 | 6 | 0 | 0 | NO |
| 1920x1080 | 200 | CAPTURED | SmartAPI collector status | 5 | 1 | 6 | 0 | 0 | NO |
| 390x844 | 200 | CAPTURED | SmartAPI collector status | 5 | 1 | 6 | 0 | 0 | NO |
...
| GET | /n50/v1/workspace/control-plane | 200 |


### Captured evidence

- [full page — 1440x900](../screenshots/desktop/control-plane__1440x900__full.png)
- [full page — 1920x1080](../screenshots/desktop/control-plane__1920x1080__full.png)
- [full page — 390x844](../screenshots/mobile/control-plane__390x844__full.png)
- [table 1 — 1920x1080](../screenshots/sections/control-plane__table-1.png)
- [table 2 — 1920x1080](../screenshots/sections/control-plane__table-2.png)
- [full page — 1024x768](../screenshots/tablet/control-plane__1024x768__full.png)
<!-- RUNTIME_AUDIT_END -->
