...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/chrome/AppShell.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/chrome/AppShell.tsx) |
| Components | `AppShell` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | Administration navigation; ${pageTitle} workspace sections |
