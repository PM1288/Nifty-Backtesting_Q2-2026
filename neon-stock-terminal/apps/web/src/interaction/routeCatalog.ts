...
export const ROUTE_COMMANDS: readonly RouteEntry[] = [
  ...
  { id: "three-month-strategy", group: "Strategies", label: "3Month Strategy", to: "/strategy/three-month", description: "NIFTY 500 recovery screen requiring bullish Month, Week, Day, 1H and 15m gates after recent monthly weakness", keywords: ["three month", "recovery screener", "NIFTY 500"] },
