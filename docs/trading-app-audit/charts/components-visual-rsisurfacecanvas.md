# components-visual-rsisurfacecanvas
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/RsiSurfaceCanvas.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/RsiSurfaceCanvas.tsx) |
| Components | `RsiSurfaceCanvas`, `COLOR_STOPS` |
