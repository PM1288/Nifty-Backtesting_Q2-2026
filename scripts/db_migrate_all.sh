...
log "5/36 nifty100 disclosures schema"
...
log "8/36 nifty stratlab data foundation"
...
log "9/36 nifty stratlab economics and strategy contracts"
...
log "10/36 nifty stratlab replay and results"
...
log "11/36 nifty stratlab discovery and calibration"
...
log "12/36 nifty stratlab options and parity"
...
log "13/36 nifty stratlab runtime hardening"
...
log "14/36 strategy evaluation rules of engagement"
...
log "17/36 full-path run governance"
...
log "18/36 H30 opportunity evidence V3"
...
for step in \
  ...
  "037_market_status_notifications_v1.sql:isolated market status notifications V1"; do
  migration="${step%%:*}"
  label="${step#*:}"
  log "${migration_number}/36 ${label}"
...
log "32/36 node api operational bootstrap"
...
log "33/36 option-chain watcher schema"
...
log "34/36 orchestration exports sql"
...
log "35/36 intraday intelligence sql"
...
log "36/36 recommendation overlay sql"
