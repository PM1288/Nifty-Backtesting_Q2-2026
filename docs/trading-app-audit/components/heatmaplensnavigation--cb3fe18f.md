...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/market/HeatmapLensNavigation.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/market/HeatmapLensNavigation.tsx#L10) |
| Used by routes | `/heatmap/change`, `/heatmap/rsi`, `/heatmap/will` |
| CSS modules | `./HeatmapLensNavigation.module.css` |
