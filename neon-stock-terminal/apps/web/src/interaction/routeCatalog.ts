...
export const ROUTE_COMMANDS: readonly RouteEntry[] = [
  ...
  { id: "futures-volatility", group: "Strategies", label: "Futures Volatility Screener", to: "/futures/volatility", description: "Exact NSE FOVOLT daily futures-volatility changes and next-session outcomes", keywords: ["FOVOLT", "daily volatility"] },
  ...
  { id: "scalper-dashboard", group: "Strategies", label: "Scalper Dashboard", to: "/strategy/scalper-dashboard", description: "Filter current F&O stocks using daily, weekly and monthly open/close anchors", keywords: ["monthly screener", "stock filter"] },
  { id: "three-month-strategy", group: "Strategies", label: "3Month Strategy", to: "/strategy/three-month", description: "NIFTY 500 Bull/Bear reversal screen across Month, Week, Day, 1H, 15m and 5m", keywords: ["three month", "recovery screener", "NIFTY 500"] },
  ...
  { id: "trading-analytics", group: "Strategies", label: "Trading Analytics", to: "/strategy/trading-analytics", description: "Institutional morning brief, NIFTY options and EMA research", keywords: ["FII", "participant", "EMA", "morning brief"] },
  ...
  { id: "backtesting-reports", group: "Strategies", label: "Backtesting Reports", to: "/backtesting/reports", description: "Downloadable PDF reports and complete CSV trade ledgers", keywords: ["report", "pdf", "csv", "3Month"] },
