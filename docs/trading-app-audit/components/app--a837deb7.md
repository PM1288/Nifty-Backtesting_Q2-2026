...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/App.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/App.tsx#L111) |
| Used by routes | `/dashboard/stocks/:symbol`, `/backtesting/strategies/:strategyId`, `/strategy/rolling-monthly/legacy`, `/stock/:symbol` |
