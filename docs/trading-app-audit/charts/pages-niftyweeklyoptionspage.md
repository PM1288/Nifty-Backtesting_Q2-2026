...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/NiftyWeeklyOptionsPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/NiftyWeeklyOptionsPage.tsx) |
| Components | `SurfaceOverview`, `ChainTable`, `NiftyWeeklyOptionsPage`, `VIEWS` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/stock/:symbol` |
| Titles found | ${title} chain has not been captured; ${surface?.expiryRole ?? ; NIFTY Options could not be loaded; NIFTY Weekly & Monthly Options; NIFTY Options views; Weekly W0; Monthly M0 |
