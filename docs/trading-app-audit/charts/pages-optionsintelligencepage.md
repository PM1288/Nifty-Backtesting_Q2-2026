...
| Components | `ScoreBar`, `OptionsIntelligencePage` |
| Library | Apache ECharts 6 |
| Pages | `/dashboard/stocks/:symbol`, `/options/intelligence`, `/stock/:symbol` |
| Titles found | Qualification funnel; Volatility signal ranking; Option chain |
