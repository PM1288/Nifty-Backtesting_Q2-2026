...
log "5/31 nifty100 disclosures schema"
...
log "8/31 nifty stratlab data foundation"
...
log "9/31 nifty stratlab economics and strategy contracts"
...
log "10/31 nifty stratlab replay and results"
...
log "11/31 nifty stratlab discovery and calibration"
...
log "12/31 nifty stratlab options and parity"
...
log "13/31 nifty stratlab runtime hardening"
...
log "14/31 strategy evaluation rules of engagement"
...
log "17/31 full-path run governance"
...
log "18/31 H30 opportunity evidence V3"
...
for step in \
  ...
  "032_oiis_live.sql:OIIS live watchlist"; do
  migration="${step%%:*}"
  label="${step#*:}"
  log "${migration_number}/31 ${label}"
...
log "27/31 node api operational bootstrap"
...
log "28/31 option-chain watcher schema"
...
log "29/31 orchestration exports sql"
...
log "30/31 intraday intelligence sql"
...
log "31/31 recommendation overlay sql"
