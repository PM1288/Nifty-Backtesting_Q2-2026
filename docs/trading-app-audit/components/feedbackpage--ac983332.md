...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/FeedbackPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/FeedbackPage.tsx#L43) |
| Used by routes | `/dashboard/stocks/:symbol`, `/feedback`, `/options/structure`, `/options/snapshot`, `/stock/:symbol` |
| CSS modules | `./AnalyticsPage.module.css`, `./FeedbackPage.module.css` |
