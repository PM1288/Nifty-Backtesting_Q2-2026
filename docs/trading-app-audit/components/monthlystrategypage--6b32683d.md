...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/MonthlyStrategiesPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/MonthlyStrategiesPage.tsx#L157) |
| Used by routes | `/dashboard/stocks/:symbol`, `/strategy/monthly`, `/strategy/rolling-monthly`, `/stock/:symbol` |
