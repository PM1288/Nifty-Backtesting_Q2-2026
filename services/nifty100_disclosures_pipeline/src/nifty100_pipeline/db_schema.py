...
DATASET_TABLE_SUFFIXES: Final[dict[str, tuple[str, str]]] = {
    "nse_financial_results": ("data", "nse_financial_results"),
    "yf_financial_statements": ("data", "yf_financial_statements"),
    "nse_corporate_actions": ("data", "nse_corporate_actions"),
    "nse_event_calendar": ("data", "nse_event_calendar"),
