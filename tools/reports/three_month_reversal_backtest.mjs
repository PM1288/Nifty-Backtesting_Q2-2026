...
const legend = `<div class="legend"><span><i class="bull-marker"></i><b>BLUE ▲ = dated BULL qualification</b></span><span><i class="bear-marker"></i><b>YELLOW ▼ = dated BEAR qualification</b></span><span><i class="ema-marker"></i>EMA9</span><span><i class="up-marker"></i>Rising candle</span><span><i class="down-marker"></i>Falling candle</span></div>`;
