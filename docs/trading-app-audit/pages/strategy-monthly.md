...
| Field | Evidence |
| --- | --- |
| Route | `/strategy/monthly` |
| Main component | `MonthlyStrategyPage` |
...
- [1920×1080](../screenshots/desktop/strategy-monthly__1920x1080__full.png)
- [1440×900](../screenshots/desktop/strategy-monthly__1440x900__full.png)
- [1024×768](../screenshots/tablet/strategy-monthly__1024x768__full.png)
- [390×844](../screenshots/mobile/strategy-monthly__390x844__full.png)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1024x768 | 200 | CAPTURED | Monthly Strategy | 1 | 1 | 24 | 0 | 4 | NO |
| 1440x900 | 200 | CAPTURED | Monthly Strategy | 1 | 1 | 24 | 0 | 0 | NO |
| 1920x1080 | 200 | CAPTURED | Monthly Strategy | 1 | 1 | 24 | 0 | 0 | NO |
| 390x844 | 200 | CAPTURED | Monthly Strategy | 1 | 1 | 24 | 0 | 0 | NO |
...
| GET | /n50/v1/rolling-monthly/absolute-months | 200 |
| GET | /n50/v1/rolling-monthly/absolute-first-session | 200 |
| GET | /n50/v1/rolling-monthly/dashboard | 200 |


### Captured evidence

- [full page — 1440x900](../screenshots/desktop/strategy-monthly__1440x900__full.png)
- [full page — 1920x1080](../screenshots/desktop/strategy-monthly__1920x1080__full.png)
- [full page — 390x844](../screenshots/mobile/strategy-monthly__390x844__full.png)
- [table 1 — 1920x1080](../screenshots/sections/strategy-monthly__table-1.png)
- [top 1 — 1920x1080](../screenshots/sections/strategy-monthly__top-1.png)
- [full page — 1024x768](../screenshots/tablet/strategy-monthly__1024x768__full.png)
<!-- RUNTIME_AUDIT_END -->
