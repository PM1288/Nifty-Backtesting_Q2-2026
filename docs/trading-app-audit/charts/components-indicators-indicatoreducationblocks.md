# components-indicators-indicatoreducationblocks
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/indicators/IndicatorEducationBlocks.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/indicators/IndicatorEducationBlocks.tsx) |
| Components | `StatGrid`, `LeaderList`, `SectorList`, `IndicatorChartFrame`, `ChartRangeSelector`, `IndicatorHero`, `ThresholdGuideTable`, `CurrentStatusSummary`, `HeatmapScaleLegend`, `PriceIndicatorSignalChart`, `ForwardReturnHeatmap`, `StrategySummaryCards`, `EquityCurveChart`, `DrawdownChart`, `TradeReturnDistribution`, `HoldingDurationChart`, `CapitalDeploymentChart`, `OpenPositionReturnChart`, `CurrentPortfolioSection`, `StrategyPerStockTable`, `StockResultTable`, `AssumptionsCard`, `LimitationsCard`, `CHART_SANS`, `CHART_MONO`, `CHART_RANGE_OPTIONS` |
| Library | Apache ECharts 6 |
| Pages | `/backtesting`, `/backtesting/strategies/:strategyId` |
| Titles found | Price and RSI with signals; ${scenario.label} • ${scenario.capitalModeLabel} |
