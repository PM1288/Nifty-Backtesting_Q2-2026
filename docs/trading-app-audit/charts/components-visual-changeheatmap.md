# components-visual-changeheatmap
...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/components/visual/ChangeHeatmap.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/components/visual/ChangeHeatmap.tsx) |
| Components | `ChangeHeatmap`, `TOP_GUTTER`, `ROW_HEIGHT`, `SYMBOL_COL`, `CHANGE_COL`, `LABEL_GUTTER_TOTAL`, `ANIMATION_MS` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/heatmap/change`, `/stock/:symbol` |
