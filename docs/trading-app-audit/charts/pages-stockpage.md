...
| Field | Value |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/StockPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/StockPage.tsx) |
| Components | `MetricCard`, `StockPage`, `RANGES` |
| Library | CSS/DOM visualisation |
| Pages | `/dashboard/stocks/:symbol`, `/analytics/learn`, `/analytics/simulator`, `/analytics/indicators`, `/analytics/indicators/:slug`, `/analytics/stock/:symbol`, `/stock/:symbol` |
