...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/RollingMonthlyPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/RollingMonthlyPage.tsx#L333) |
| Used by routes | `/dashboard/stocks/:symbol`, `/strategy/rolling-monthly/legacy`, `/stock/:symbol` |
| CSS modules | `./RollingMonthlyPage.module.css` |
