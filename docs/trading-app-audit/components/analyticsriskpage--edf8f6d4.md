...
| Field | Evidence |
| --- | --- |
| Source | [neon-stock-terminal/apps/web/src/pages/AnalyticsRiskPage.tsx](/home/novius2/NIFTY50/Nifty-Backtesting_Q2-2026/neon-stock-terminal/apps/web/src/pages/AnalyticsRiskPage.tsx#L78) |
| Used by routes | `/dashboard/stocks/:symbol`, `/analytics/regime`, `/analytics/risk`, `/analytics/system/quality`, `/analytics/system/map`, `/stock/:symbol` |
