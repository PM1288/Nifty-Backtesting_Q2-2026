...
import (
	...
	"trading-stack/internal/strategy"
)
...
func main() {
	...
	runtimeCfg.ServiceName = "strategy-engine"
	...
	engine := strategy.NewEngine(cfg, st, baseLogger, loc)
	if err := engine.Run(ctx); err != nil && ctx.Err() == nil {
		logger.Error("strategy engine exited", "err", err)
		os.Exit(1)
	}
}
